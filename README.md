...
- However, if the template code has been copied from this project (i.e. <https://github.com/auberginehill/list-my-apps-template-data>) [dollar_sign] strings should be left as they are.
